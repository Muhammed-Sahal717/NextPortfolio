...
const SidebarContent = ({ setMobileOpen, isActive }: { setMobileOpen: (open: boolean) => void, isActive: (href: string) => boolean }) => (
  <>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <>
            ...
            >
              <SidebarContent setMobileOpen={setMobileOpen} isActive={isActive} />
            </motion.aside>
          </>
        )}
      </AnimatePresence>
