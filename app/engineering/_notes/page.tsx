      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-zinc-950 border border-zinc-200 dark:border-[1px] dark:border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-10 max-w-4xl w-full relative shadow-2xl dark:shadow-[0_0_50px_rgba(132,204,22,0.1)] overflow-hidden max-h-[85vh] flex flex-col z-10 transition-all"
